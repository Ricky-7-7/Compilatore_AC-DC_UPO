...
class TestParser {
    ...
    private static final String DATA_DIR = "src/test/data/testParser/";

    @Test
    void testParserCorretto1() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserCorretto1.txt");
    ...
    void testParserCorretto2() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserCorretto2.txt");
        Parser parser = new Parser(scanner);
        assertDoesNotThrow(() -> {
            parser.parse();
        });
    ...
    void testParserEcc_0() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_0.txt");
        Parser parser = new Parser(scanner);
    ...
    void testParserEcc_1() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_1.txt");
        Parser parser = new Parser(scanner);
        SyntacticException e = assertThrows(SyntacticException.class, () -> {
            parser.parse();
        });
    ...
    void testParserEcc_2() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_2.txt");
        Parser parser = new Parser(scanner);
    ...
    void testParserEcc_3() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_3.txt");
        Parser parser = new Parser(scanner);
        SyntacticException e = assertThrows(SyntacticException.class, () -> {
            parser.parse();
        });
    ...
    void testParserEcc_4() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_4.txt");
        Parser parser = new Parser(scanner);
        SyntacticException e = assertThrows(SyntacticException.class, () -> {
            parser.parse();
        });
    ...
    void testParserEcc_5() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_5.txt");
        Parser parser = new Parser(scanner);
        SyntacticException e = assertThrows(SyntacticException.class, () -> {
            parser.parse();
        });
    ...
    void testParserEcc_6() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_6.txt");
        Parser parser = new Parser(scanner);
        SyntacticException e = assertThrows(SyntacticException.class, () -> {
            parser.parse();
        });
    ...
    void testParserEcc_7() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testParserEcc_7.txt");
        Parser parser = new Parser(scanner);
        SyntacticException e = assertThrows(SyntacticException.class, () -> {
            parser.parse();
        });
    ...
    @Test
    void testParserSoloDichiarazioni() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testSoloDich.txt");
        Parser parser = new Parser(scanner);
        assertDoesNotThrow(() -> {
            parser.parse();
        });
    ...
    @Test
    void testParserSoloDichiarazioniPrint() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "/testSoloDichPrint.txt");
        Parser parser = new Parser(scanner);
        assertDoesNotThrow(() -> {
            parser.parse();
        });
    ...
    @Test
    void testASTDichiarazioniPrint() throws Exception {
        Scanner scanner = new Scanner(DATA_DIR + "testSoloDichPrint.txt");
        Parser parser = new Parser(scanner);
        NodeProgram ast = parser.parse();
